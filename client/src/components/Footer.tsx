        ...
        <div className="flex flex-col md:flex-row justify-between mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="manuals">
              ...
              <ul>
                <li>
                  <a href="/manuals/fs0101.pdf" className="text-neutral-300 hover:text-emerald-400 transition">
                    FS0101 Manual
                  </a>
                </li>
                <li>
                  <a href="/manuals/fs0102.pdf" className="text-neutral-300 hover:text-emerald-400 transition">
                    FS0102 Manual
                  </a>
                </li>
              </ul>
